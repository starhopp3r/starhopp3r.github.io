...
$$ \ln I(t)-\frac{V_{S}}{R}-\ln I(0)-\frac{V_{S}}{R}=-\frac{R}{L} t $$
...
Where $V$ is the battery's supply voltage (I'm sticking to $V$ to ensure consistency with the Faraday's Law version of the solution). The voltage across the inductor is measured to be +2.360 V. Therefore, Dr. Lewin made the measurements at precisely
