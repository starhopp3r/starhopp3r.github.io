...
cover: /assets/img/covers/tinychat-1440.webp
cover_small: /assets/img/covers/tinychat-720.webp
cover_alt: A compact LicheeRV Nano single-board computer
dek: Building, training, and running a 15-million-parameter conversational model on a tiny RISC-V board.
---
...
_The Sipeed LicheeRV Nano W next to an old stamp from Sri Lanka sourced from my dad's stamp collection_
